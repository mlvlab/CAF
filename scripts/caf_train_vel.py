"""
Train a Constant Acceleration Flow Velocity model
"""
...
from flow.train_util import CAFTrainLoopVel
...
def main():
    ...
    velmodel, diffusion = create_model_and_flow(
...
def create_argparser():
    ...
    defaults.update(caf_vel_defaults(defaults['data_name']))
